...
eq_contour_plot('default_params_full.mat', params, 'I zero', X, Y, 'uu_zero', 'DF');
eq_contour_plot('default_params_full.mat', params, 'I star', X, Y, 'uu_star', 'DF');

% contour plot with default parameters for IIS model (US)
params.b_2 = 9;
eq_contour_plot('default_params_full.mat', params, 'I zero', X, Y, 'us_zero', 'DF');
eq_contour_plot('default_params_full.mat', params, 'I star', X, Y, 'us_star', 'DF');

% contour plot with default parameters for IIS model (SU)
params.beta = 2.05*10^(-4);
params.b_2 = 0.2;
eq_contour_plot('default_params_full.mat', params, 'I zero', X, Y, 'su_zero', 'DF');
eq_contour_plot('default_params_full.mat', params, 'I star', X, Y, 'su_star', 'DF');
...
eq_contour_plot('default_params_full.mat', params, 'I zero', X, Y, 'viral_contour_df', 'DF');
params.beta = 10*defaults.d_v*defaults.d_y*defaults.d_x/(defaults.k * defaults.mu);
eq_contour_plot('default_params_full.mat', params, 'I zero', X, Y, 'viral_contour_e', 'E');
...
function eq_contour_plot(params_file, params, steady_state, X, Y, title, state)
    % loading defaults
