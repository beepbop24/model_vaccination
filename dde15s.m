function sol = dde15s(ddefun,lags,history,tspan,options,varargin) 
...
%
% This code works with MATLAB 6.5 (R13). In particular, it uses 
% ODE15S Revision 1.83.  Some modifications to SOLEXTEND may be 
